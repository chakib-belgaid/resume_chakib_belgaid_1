...
\begin{paracol}{2}
  ...
  \cvevent{Assistant Teacher}{ University of lille }{2021– Present}{Lille, France}
  ...
  \end{itemize}
  \subevent{Product}
  \cproduct{\href{https://github.com/chakib-belgaid/circuitmaze}{Circuit Maze}}{Platform to teach fundamentals of electronics to BCs students using gamification approach}{Django,AngularJs,Js}
  \divider
  \newpage
